...
#define DEBUG_CLASS_OSS             (1<<10)
#define DEBUG_CLASS_TESTING         (1<<11)
#define DEBUG_CLASS_ANALYZE         (1<<12)
#define DEBUG_CLASS_FULL            (0xFFFF - DEBUG_CLASS_MIDI_EVENT - DEBUG_CLASS_TX_TIMING - DEBUG_CLASS_MIDI_NOTE - DEBUG_CLASS_TESTING - DEBUG_CLASS_OSS - DEBUG_CLASS_ANALYZE)
